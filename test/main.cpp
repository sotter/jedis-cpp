...
const char * g_c_keystring[] =
		{ "keyStr1_C", "keyStr2_C", "keyStr3_C", "keyStr4_C", "keyStr5_C", "keyStr6_C", "字符串键7_C" };

const char *g_c_valuestring[] =
		{ "Test_keyStr1", "Test_keyStr2~!`@#$^&*()_+=-:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//",
...
const char * g_java_keystring[] = { "keyStr1", "keyStr2", "keyStr3", "keyStr4", "keyStr5", "keyStr6", "字符串键7" };
...
const char * g_c_keyhash[] = { "keyHash1_C", "keyHash2_C", "keyHash3_C", "keyHash4_C", "keyHash5_C", "keyHash6_C",
		"keyHash7_C", "keyHash1_C", };

const char * g_c_fieldhash[] = { "filed1", "filed", "filed", "", "filed", "filed", "filed", "filed8" };

const char *g_c_valuehash[] =
		{ "Test_keyHash1", "Test_keyHash2~!`@#$^&*()_+=-:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//", "中交兴路哈希写入测试3，开始测试啦。", "", "",
...
const char * g_java_keyhash[] = { "keyHash1", "keyHash2", "keyHash3", "keyHash4", "keyHash5", "keyHash6", "keyHash7",
		"keyHash1" };
...
const char * g_c_keylist[] = { "keyList1_C", "keyList2_C", "keyList3_C", "keyList4_C", "keyList5_C", "keyList6_C" };

const char * g_c_valuelist[] =
		{ "Test_keyList1", "Test_keyList2~!`@#$^&*()_+=-:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//",
...
const char * g_java_keylist[] = { "keyList1", "keyList2", "keyList3", "keyList4", "keyList5", "keyList6" };
...
const char * g_c_keyset[] = { "keySet1_C", "keySet2_C", "keySet3_C", "keySet4_C", "keySet5_C", "keySet6_C" };

const char *g_c_valueset[] =
		{ "Test_keySet1", "Test_keySet2~!`@#$^&*()_+=-:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//", "中交兴路字符集写入测试3，开始测试啦。", "",
				"Test_keySet5-start@#$^&*()+=:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//中交兴路有序字符集写入测试3，开始测试啦-end",
				"C长数据-Test_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exit" };

const char * g_java_keyset[] = { "keySet1", "keySet2", "keySet3", "keySet4", "keySet5", "keySet6" };
...
const char * g_c_keysortset[] = { "keySortSet1_C", "keySortSet2_C", "keySortSet3_C", "keySortSet4_C", "keySortSet5_C",
		"keySortSet6_C" };

const char *g_c_valuesortset[] =
		{ "Test_keySortSet1", "Test_keySortSet2~!`@#$^&*()_+=-:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//",
				"中交兴路有序字符集写入测试3，开始测试啦。", "",
				"Test_keySortSet5-start@#$^&*()+=:;<>?/.,|\\'{}[1122]※λΩβΣ\\n\\//中交兴路有序字符集写入测试3，开始测试啦-end",
				"C长数据-Test_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exitTest_keyStr5~!{12345678901234567890}[1122]+‘中交兴路字符串写入测试3，开始测试啦。’exit" };

const char * g_java_keysortset[] = { "keySortSet1", "keySortSet2", "keySortSet3", "keySortSet4", "keySortSet5",
		"keySortSet6" };
...
const char *g_testdata[] = { "test.", "test~!@#$%^&*()_+=-:;<>?/.,|\',", "中交兴路", "中交兴路2012~!@#$%^&*()_+=-:;<>?/.,|\'" };
...
void JedisTest::TestReadString(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
		string value)
{
...
void JedisTest::TestWriteString(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
...
void JedisTest::TestDelString(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, bool bCheck)
{
	string strKey = g2u(key);
...
void JedisTest::TestReadHash(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string field,
		string value)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestReadHash(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
...
void JedisTest::TestWriteHash(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
		string field, string value, bool bCheck)
{
	string strResult, strWriteValue, strReadValue;
	string strKey = g2u(key);
	string strField = g2u(field);
...
void JedisTest::TestDelHash(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string field,
		bool bCheck)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestReadList(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string value,
		bool bLeft)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestWriteList(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
		string value, bool bLeft, bool bCheck)
{
	string strResult, strWriteValue, strReadValue;
	string strKey = g2u(key);
	strWriteValue = g2u(value);
...
void JedisTest::TestDelList(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string value,
		int iCount)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestReadSet(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string value)
{
	string strResult, strValue;
	string strKey = g2u(key);
	strValue = g2u(value);
...
void JedisTest::TestWriteSet(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string value,
		bool bCheck)
{
	string strResult, strWriteValue, strReadValue;
	string strKey = g2u(key);
...
void JedisTest::TestWriteSet(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
...
void JedisTest::TestDelSet(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, string value,
		bool bCheck)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestReadSortset(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
...
void JedisTest::TestWriteSortset(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
		string value, double score, bool bCheck)
{
...
void JedisTest::TestDelSortset(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key,
		string value, bool bCheck)
{
	string strResult, strValue;
	string strKey = g2u(key);
...
void JedisTest::TestInc(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, bool bCheck)
{
	string strResult;
	string strKey = g2u(key);
...
void JedisTest::TestDec(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, bool bCheck)
{
	string strResult;
	string strKey = g2u(key);
...
void JedisTest::TestIncBy(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, int iStep,
		bool bCheck)
{
	string strResult;
	string strKey = g2u(key);
...
void JedisTest::TestDecBy(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, string key, int iStep,
		bool bCheck)
{
	string strResult;
	string strKey = g2u(key);
...
void JedisTest::TestString(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, int mode)
{
	switch (mode) {
	case 1:	//	读
	{
...
void JedisTest::TestList(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, int mode)
{
	switch (mode) {
	case 1:	//	读
	{
...
void JedisTest::TestSet(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, int mode)
{
	switch (mode) {
	case 1:	//	读
	{
...
void JedisTest::TestSortset(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, int mode)
{
	switch (mode) {
	case 1:	//	读
	{
...
void JedisTest::TestHash(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable, int mode)
{
	switch (mode) {
	case 1:	//	读
	{
...
void JedisTest::TestVar(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable)
{
...
void JedisTest::TestDel(DataCenter& datacenter, RedisDB& redisdb, RedisTable& redistable)
{
